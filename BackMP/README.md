...
Backend para aplicación de gestión de MP.
...
El proyecto utiliza TypeORM con MySQL/MariaDB. Las migraciones se manejan automáticamente en desarrollo y deben ser ejecutadas manualmente en producción.
