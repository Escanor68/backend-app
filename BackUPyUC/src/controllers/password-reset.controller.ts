...
export class PasswordResetController {
    ...
    constructor() {
        ...
        console.log('🏗️ [PasswordResetController] Inicializando PasswordResetController...');
        console.log(
    ...
    async requestPasswordReset(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            console.log('🔑 [PasswordResetController] requestPasswordReset - Iniciando...');

            const dto = plainToClass(RequestPasswordResetDto, req.body);
            const errors = await validate(dto);

            if (errors.length > 0) {
                console.log('❌ [PasswordResetController] Errores de validación:', errors);
    ...
    async resetPassword(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            console.log('🔑 [PasswordResetController] resetPassword - Iniciando...');
            ...
            console.log('✅ [PasswordResetController] Contraseña restablecida exitosamente');
            res.status(200).json({
