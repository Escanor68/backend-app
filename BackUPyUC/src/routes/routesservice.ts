...
router.post(
    `/api/v1/userPlayer/request-password-reset`,
    userPlayerController.sendToken,
);
router.put(
...
router.post(
    `/api/v1/userField/request-password-reset`,
    userFieldController.sendToken,
);
router.put(
    `/api/v1/userField/reset-password/:token`,
    userFieldController.resetPassword,
);
router.get(`/api/v1/userField/getNearby`, userFieldController.getNearbyFields);
